...
var DRIVER = [
  ...
  "is lost. Replacing an actively running Worker requires interrupt true, which stops it first. The human may",
  "still message or stop the Split Worker directly; treat that intervention as authoritative, and use",
  "close_partner immediately when they ask to close or dismiss the pane.",
  "",
