...
import { initServerSettings, updateSettingsStats, updateSettingsModels, updateDaemonConfig, handleSetPinResult, handleKeepAwakeChanged, handleRestartResult, handleShutdownResult, handleSharedEnv, handleSharedEnvSaved, handleGlobalClaudeMdRead, handleGlobalClaudeMdWrite, resetRestartButton } from './modules/server-settings.js';
      ...
      switch (msg.type) {
        ...
        case "info":
          ...
          if (msg.version) {
            ...
            var uiVEl = document.getElementById("user-island-version");
            if (uiVEl) uiVEl.textContent = "Clay v" + msg.version;
          }
