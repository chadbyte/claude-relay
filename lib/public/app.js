...
// --- DOM refs ---
  ...
  if (fileBrowserBtn) fileBrowserBtn.addEventListener("click", function () { closeProjectLogs(); if (isArchiveOpen()) closeArchive(); if (isSchedulerOpen()) closeScheduler(); });
  if (gitSidebarBtn) gitSidebarBtn.addEventListener("click", function () { closeProjectLogs(); if (isArchiveOpen()) closeArchive(); if (isSchedulerOpen()) closeScheduler(); });
  if (terminalSidebarBtn) terminalSidebarBtn.addEventListener("click", function () { closeProjectLogs(); if (isArchiveOpen()) closeArchive(); if (isSchedulerOpen()) closeScheduler(); });
