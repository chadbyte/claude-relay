...
// --- DOM refs ---
  ...
  function enterDmMode(user) { _dmEnterDmMode(user); }
  function exitDmMode(skipProjectSwitch) { _dmExitDmMode(skipProjectSwitch); }
  function handleMateCreatedInApp(mate) { _dmHandleMateCreatedInApp(mate); }
  function renderAvailableBuiltins() { _dmRenderAvailableBuiltins(); }
  function buildMateInterviewPrompt() { return _dmBuildMateInterviewPrompt(); }
  function updateMateIconStatus(mateId, status) { _dmUpdateMateIconStatus(mateId, status); }
  function connectMateProject(mate) { _dmConnectMateProject(mate); }
