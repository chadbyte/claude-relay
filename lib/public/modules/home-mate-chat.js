...
var messages = [], streamingText = "";
var streaming = false, bound = false, animateSwitch = false;
var chatEl = null, stageEl = null, messagesEl = null, suggestionsEl = null;
var inputEl = null, sendBtn = null, sessionModelEl = null, sessionModelValueEl = null, sessionModelChooseEl = null;
var sessionRequestSequence = 0, activeSessionRequestId = null, mateCreationActive = false;
...
export function renderHomeChat() {
  ...
  inputEl.disabled = debateLaunching || mateCreationActive || !!debatePhase || !mateId || awaitingQuestion || !hasCommittedSessionModel();
  ...
  sendBtn.disabled = debateLaunching || mateCreationActive || !!debatePhase || !mateId || streaming || awaitingQuestion || !hasCommittedSessionModel() || !inputEl.value.trim();
  renderSessionModel();
