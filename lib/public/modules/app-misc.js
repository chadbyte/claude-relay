...
export function initMisc() {
  ...
  window.addEventListener("message", function(event) {
    ...
    if (msg.type === "clay_ext_mcp_servers") {
      var ws2 = getWs();
    ...
    if (msg.type === "clay_ext_mcp_result") {
      var ws3 = getWs();
    ...
    // MCP bridge: tool error from extension
    if (msg.type === "clay_ext_mcp_error") {
      var ws4 = getWs();
