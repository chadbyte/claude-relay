...
import { openHomeScheduler } from './scheduler.js';
...
function openScheduledTasksFromSidebar() {
  openHomeScheduler();
  closeNarrowDrawer(false);
}
...
export function initHomeSidebar() {
  ...
  document.getElementById("home-scheduler-btn").addEventListener("click", openScheduledTasksFromSidebar);
