...
import { getHomeSessionConversations, createHomeSessionActionsTrigger, disposeHomeSessionActionsMenu, syncHomeSessionDetails } from './home-session-actions.js';
...
function renderRecentConversations() {
  ...
  list.innerHTML = "";
  var conversations = getHomeSessionConversations().slice(0, 5);
  ...
  for (var i = 0; i < conversations.length; i++) {
    (function (conversation) {
      ...
      if (conversation.mateId === activeMateId && conversation.sessionId === activeSessionId) {
      ...
      item.appendChild(createHomeSessionActionsTrigger(conversation));
