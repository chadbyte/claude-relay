...
export function openHomeMateProperty(kind, mateId, mateName, options) {
  ...
  if (kind === "model") resetHomeMateModelPicker(mateId, activeMateName, getMate(mateId), options && options.sessionId);
