...
import { handleProjectLogsState, handleProjectLogEntry, handleProjectLogSaved, handleProjectLogsError } from './project-logs.js';
...
export function processMessage(msg) {
    ...
    switch (msg.type) {
      ...
      case "project_log_saved":
        handleProjectLogSaved(msg);
        break;
