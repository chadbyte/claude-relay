...
import { openHomeChat, handleHomeMateHistory, handleHomeMateDelta, handleHomeMateDone, handleHomeMateError } from './home-mate-chat.js';
import { handleHomeMateMemoryState, handleHomeMateKnowledgeState } from './home-mate-properties.js';
...
import { handleBoardState, handleBoardCardChanged, handleBoardCardDeleted, handleBoardError } from './home-board.js';
import { handleToolsState, handleToolInstalled, handleToolRemoved, handleToolStorageResult, handleToolsError, handleToolControlRequest } from './home-tools.js';
...
export function processMessage(msg) {
    ...
    switch (msg.type) {
      ...
      case "board_done_updated":
        handleBoardCardChanged(msg);
        break;

      case "board_card_deleted":
        handleBoardCardDeleted(msg);
        break;

      case "board_error":
        handleBoardError(msg);
        break;
