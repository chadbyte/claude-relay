...
function toggleDmUserPicker(anchorEl) {
  ...
  // --- MATES section ---
  // The `dm-picker-mates-only` marker class lets the body.mates-disabled
  // CSS gate hide the entire Mates portion of the picker (label, list,
  // create entry, and divider) when the user has turned off Mates UI.
  var matesSectionLabel = document.createElement("div");
  matesSectionLabel.className = "dm-user-picker-section dm-picker-mates-only";
  matesSectionLabel.textContent = "Mates";
  picker.appendChild(matesSectionLabel);

  var matesListEl = document.createElement("div");
  matesListEl.className = "dm-user-picker-list dm-mates-list dm-picker-mates-only";
  ...
  createMateEl.className = "dm-user-picker-create-mate dm-picker-mates-only";
  ...
  divider.className = "dm-picker-mates-only";
