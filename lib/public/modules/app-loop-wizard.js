...
var wizardData = { name: "", task: "", maxIterations: null, cron: null };
...
// Init
// ========================================================
export function initLoopWizard(ctx) {
  _ctx = ctx;
...
export function openRalphWizard(source) {
  requireClayRalph(function () {
    ...
    wizardData = { name: "", task: "", maxIterations: null };
    ...
    if (_ctx.setExecModalShown) _ctx.setExecModalShown(false);
...
function collectWizardData() {
  wizardData.name = "";
  wizardData.maxIterations = null; // set at execution time
  wizardData.cron = buildWizardCron();
  wizardData.loopMode = loopModeChoice;
  wizardData.promptAuthor = promptAuthor;
  wizardData.judgeAuthor = (loopModeChoice === "judge") ? judgeAuthor : null;
  // Derive mode for backward compat
  wizardData.mode = (promptAuthor === "me") ? "own" : "draft";
