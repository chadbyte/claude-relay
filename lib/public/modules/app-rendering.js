...
export function addAuthRequiredMessage(msg) {
  ...
  if (msg.canAutoLogin) {
    ...
    loginBtn.addEventListener("click", function () {
      store.set({ pendingTermCommand: "claude\n" });
...
export function showSuggestionChips(suggestion) {
  ...
  var suggestionChipsEl = document.getElementById("suggestion-chips");
...
export function hideSuggestionChips() {
  ...
  getMessagesEl().style.paddingBottom = "";
}
