...
import { registerDockTool, renderDock } from './home-dock.js';
...
var boardDockEl = null;
var addMateMenu = null;

function registerHomeDockTools() {
  registerDockTool({
    id: "board",
    name: "Board",
    ...
    render: function (contentEl) {
      if (!boardDockEl) {
        boardDockEl = document.createElement("div");
        boardDockEl.className = "home-board";
        boardDockEl.id = "home-board";
      }
      contentEl.appendChild(boardDockEl);
      renderBoard();
    },
    onShow: function () { requestBoard(); },
  });
}
