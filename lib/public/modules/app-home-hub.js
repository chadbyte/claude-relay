...
function syncMateContextControls(mate) {
  ...
  var defaultModel = mate ? (mate.model || "Choose model") : "Loading model…";
  var controls = [
  ...
  for (var i = 0; i < controls.length; i++) {
    ...
    if (controls[i][0] === "home-sidebar-model" && mate) {
      control.setAttribute("aria-label", "Choose a model for " + name + ". Default for new conversations: " + defaultModel);
    } else {
