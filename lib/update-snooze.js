...
// Deliberately not config.isPidAlive: that helper reports EPERM as dead, which
// is wrong here. EPERM means the process exists but belongs to another user —
// exactly the case of a second daemon run by someone else — and treating it as
// dead would steal a live lock.
