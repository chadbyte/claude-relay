...
var schema = {
  ...
  "home_surface_get":         { direction: "c2s", handler: "lib/server-home-preferences.js", description: "Request the current user's durable Home conversation selection" },
  "home_surface_set":         { direction: "c2s", handler: "lib/server-home-preferences.js", description: "Persist the current user's durable Home conversation selection" },
  "home_surface_state":       { direction: "s2c", handler: "lib/public/modules/home-surface.js", description: "Current user Home conversation selection" },
  ...
  // Home work board
  // -----------------------------------------------------------------------
  "board_list":               { direction: "c2s", handler: "lib/server-board.js", description: "Request all cards on the current user's board" },
  "board_card_create":        { direction: "c2s", handler: "lib/server-board.js", description: "Create a native board card" },
  "board_card_update":        { direction: "c2s", handler: "lib/server-board.js", description: "Update mutable fields on a board card" },
  "board_card_move":          { direction: "c2s", handler: "lib/server-board.js", description: "Move a board card to a fixed column" },
  "board_card_delete":        { direction: "c2s", handler: "lib/server-board.js", description: "Delete a board card" },
  "board_done_confirm":       { direction: "c2s", handler: "lib/server-board.js", description: "Accept or reject a mate's completion proposal" },
  "board_state":              { direction: "s2c", handler: "lib/server-board.js", description: "Full board card state" },
  "board_card_created":       { direction: "s2c", handler: "lib/server-board.js", description: "A board card was created" },
  "board_card_updated":       { direction: "s2c", handler: "lib/server-board.js", description: "A board card's mutable fields changed" },
  "board_card_moved":         { direction: "s2c", handler: "lib/server-board.js", description: "A board card moved to another column" },
  "board_card_deleted":       { direction: "s2c", handler: "lib/server-board.js", description: "A board card was deleted" },
  "board_done_updated":       { direction: "s2c", handler: "lib/server-board.js", description: "A card completion proposal was accepted or rejected" },
  "board_error":              { direction: "s2c", handler: "lib/server-board.js", description: "A board request failed validation or storage" },
  ...
  "tool_install":             { direction: "c2s", handler: "lib/server-tools.js", description: "Install or replace a declarative tool" },
  ...
  "home_mate_new_session":    { direction: "c2s", handler: "lib/server-home-chat.js", description: "Start a fresh embedded session with the selected mate" },
  "home_mate_close":          { direction: "c2s", handler: "lib/server-home-chat.js", description: "Tear down the embedded mate session tap" },
  "home_mate_memory_list":    { direction: "c2s", handler: "lib/server-home-chat.js", description: "Request the selected mate's read-only memory projection" },
  "home_mate_knowledge_list": { direction: "c2s", handler: "lib/server-home-chat.js", description: "Request the selected mate's read-only knowledge file list" },
  "home_mate_models_get":     { direction: "c2s", handler: "lib/server-home-chat.js", description: "Request the selected Mate vendor's model catalog" },
  "home_mate_model_set":      { direction: "c2s", handler: "lib/server-home-chat.js", description: "Persist the selected Mate's default model for new Home conversations" },
  ...
  "home_mate_sessions_state": { direction: "s2c", handler: "lib/public/modules/home-mate-chat.js", description: "Current user's conversations with the selected mate" },
  ...
  "home_mate_memory_state":   { direction: "s2c", handler: "lib/public/modules/home-mate-properties.js", description: "Selected mate's read-only memory summary and entries" },
  "home_mate_knowledge_state": { direction: "s2c", handler: "lib/public/modules/home-mate-properties.js", description: "Selected mate's read-only knowledge file list" },
  "home_mate_models_state":   { direction: "s2c", handler: "lib/public/modules/home-mate-properties.js", description: "Correlated Mate model catalog state" },
  "home_mate_model_result":   { direction: "s2c", handler: "lib/public/modules/home-mate-properties.js", description: "Correlated Mate model selection result" }
};
