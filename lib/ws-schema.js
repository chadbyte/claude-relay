...
var schema = {
  ...
  "project_log_create":       { direction: "c2s", handler: "lib/project-logs.js", description: "Create a project log entry attributed to the connected user" },
  "project_log_update":       { direction: "c2s", handler: "lib/project-logs.js", description: "Revise a project log entry, retaining the previous revision and its author" },
  ...
  "project_log_saved":        { direction: "s2c", handler: "lib/public/modules/project-logs.js", description: "Correlated project log entry after a create or update" },
