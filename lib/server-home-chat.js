  ...
  function sendHistory(ws, found, session, requestId) {
    ...
    try {
      var payload = {
        ...
        messages: historyToHomeChat(session.history || [], session.debateSetupMode === true),
