      ...
      try {
        ...
        try {
          if (fs.existsSync(claudePath)) {
            prevIdentity = extractIdentity(fs.readFileSync(claudePath, "utf8"));
          }
        } catch (e) {}
        logIdentityChange(mateDir, "sync_primary_v" + latestVersion, latestIdentity.trimEnd(), prevIdentity);
        console.log("[mates] Primary mate updated: " + mate.name + " (v" + currentVersion + " -> v" + latestVersion + ")");
      } catch (e) {
