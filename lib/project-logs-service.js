...
//   - Members of a shared project read each other's entries with attribution.
...
function attachProjectLogsService(ctx) {
  ...
  function createProjectBound(initial, revalidate) {
    ...
    return {
      ...
      createLog: function (args) { return live().create(args || {}, author()); },
      updateLog: function (args) { return live().update(args && args.ref, args || {}, author()); },
      linkLog: function (args) { return live().link(args && args.ref, args && args.links, author()); },
      removeLog: function (args) { return live().remove(args && args.ref, author()); },
    };
  }
