...
function createCodexQueryHandle(appServer, queryOpts) {
  ...
  function handleServerEvent(msg) {
      ...
      if (canUseTool) {
        canUseTool("Bash", { command: cmdParams.command }, {}).then(function(decision) {
          if (decision === true) {
            ...
            appServer.respond(msg.id, "acceptForSession");
          } else {
        ...
        // No permission handler, auto-accept
        appServer.respond(msg.id, "accept");
      }
      return;
    }
    ...
    if (method === "item/tool/requestUserInput" || method === "mcpServer/elicitation/request") {
      ...
      console.log("[yoke/codex] MCP approval request, auto-approving:", (msg.params || {}).serverName || "unknown");
