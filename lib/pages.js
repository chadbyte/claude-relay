...
function adminSetupPageHtml() {
  return '<!DOCTYPE html><html lang="en"><head>' +
    ...
    '<div class="sub">Choose a username</div>' +
    ...
    '<div class="sub">Choose a display name</div>' +
...
function smtpLoginPageHtml() {
  return '<!DOCTYPE html><html lang="en"><head>' +
    ...
    '<div class="sub">Log in with username &amp; PIN</div>' +
    '<div class="field"><label>Username</label>' +
...
function smtpInvitePageHtml(inviteCode) {
  return '<!DOCTYPE html><html lang="en"><head>' +
    ...
    // Step 2: Email
    '<div class="step" id="step1">' +
    '<div class="sub">Enter your email for login</div>' +
    '<div class="field"><label>Email</label>' +
