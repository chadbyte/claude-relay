      ...
      try {
        ...
        var askUserToolDefs = askUserMcp.getToolDefs(function onAsk(input) {
          return new Promise(function (resolve, reject) {
            ...
            // Require a live session; if routing fails, fail closed rather
            // than fabricating an answer for the wrong mate.
            if (!session) {
              reject(new Error("ask-user: no active session in " + slug));
              return;
            }
