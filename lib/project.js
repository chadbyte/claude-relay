  ...
  function getMcpBridgeHandler(sessionId, sessionOnly) {
    ...
    return {
      listTools: function () {
        ...
        if (localMcp) {
          ...
          for (var i = 0; i < inAppNames.length; i++) {
            ...
            if (inAppNames[i] === "clay-debate" || inAppNames[i] === "clay-workspace" || inAppNames[i] === "clay-history") continue;
      ...
      callTool: function (serverName, toolName, args) {
        ...
        if (serverName === "clay-sessions" || serverName === "clay-notes" || serverName === "clay-handoff" || serverName === "clay-documents" || serverName === "clay-debate" || serverName === "clay-workspace" || serverName === "clay-history") {
