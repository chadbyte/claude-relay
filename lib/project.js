...
function createProjectContext(opts) {
  ...
  function createToolControlMcpServer() {
    ...
    var boardSkills = [
      "Use create to add a card, update to edit card fields, and move to change columns.",
      "A mate cannot move a card to done. Use proposeDone so the user can confirm completion.",
    ].join("\n");
    var handlers = {
      list: function () {
        var manifests = listControllableTools(userId) || [];
        var tools = [{ id: "board", name: "Board", native: true, skills: boardSkills }];
  ...
  function handleMessage(ws, msg) {
    ...
    if (msg.type === "dm_open" || msg.type === "dm_send" || msg.type === "dm_list" || msg.type === "dm_typing" || msg.type === "dm_add_favorite" || msg.type === "dm_remove_favorite" || msg.type === "mate_create" || msg.type === "mate_list" || msg.type === "mate_delete" || msg.type === "mate_update" || msg.type === "mate_readd_builtin" || msg.type === "mate_list_available_builtins" || msg.type === "email_accounts_list" || msg.type === "email_account_add" || msg.type === "email_account_remove" || msg.type === "email_account_test" || msg.type === "home_mate_open" || msg.type === "home_mate_send" || msg.type === "home_mate_new_session" || msg.type === "home_mate_close" || msg.type === "board_list" || msg.type === "board_card_create" || msg.type === "board_card_update" || msg.type === "board_card_move" || msg.type === "board_card_delete" || msg.type === "board_done_confirm" || msg.type === "tools_list" || msg.type === "tool_get" || msg.type === "tool_install" || msg.type === "tool_remove" || msg.type === "tool_storage_op" || msg.type === "tool_control_response") {
