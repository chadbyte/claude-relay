...
function createProjectContext(opts) {
  ...
  function handleMessage(ws, msg) {
    ...
    if (msg.type === "get_vendor_models") {
      ...
      var defaultModel = vendorModels[0] || "";
      sendTo(ws, { type: "model_info", model: defaultModel, models: vendorModels, vendor: msg.vendor, availableVendors: sm.availableVendors || [] });
      return;
    }
