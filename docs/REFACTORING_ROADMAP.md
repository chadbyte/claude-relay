...
**Last completed**: PR-37 (2026-04-11)
**Next up**: PR-38
...
| PR-28 | done | Extract `app-rendering.js` from `app.js` | 2026-04-10 |
...
| `lib/public/modules/sidebar.js` | 4,541 | 1,586 | ~400 |
...
| PR-28 | done | `lib/public/modules/app-rendering.js` | app.js | 597 |
